...
public class GroupingByExampleThreeLevel {
    ...
    //In this example, we are grouping students by their names and then by the number of notebooks they have, using a TreeMap to maintain the order of names.
    public static void groupingByNameAndNoteBooks(){

        TreeMap<String,Integer> students =  StudentDataBase.getAllStudents()
                .stream()
